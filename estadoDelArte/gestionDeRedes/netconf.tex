...
Cada mensaje del protocolo \gls{NETCONF} es un documento \gls{XML} bien formado y codificado usando UTF-8. Las solicitudes y las respuestas se relacionan entre si mediante un atributo ``message-id'' de forma que el protocolo \gls{NETCONF} permite el ``pipelining'' de mensajes.
